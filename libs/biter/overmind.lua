...
Overmind.Logger = Logger.new("Misanthrope", "overmind", DEBUG_MODE)
...
Overmind.tick_rates.scan_chunk = 5
...
Overmind.stages.evaluate_base = function(data)
    for i = 1, 25 do
        ...
        local adj_chunk = table.remove(data.adjacent)
